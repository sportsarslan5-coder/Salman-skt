...
import { ShoppingBag, Menu, X, Search, MessageCircle, Instagram, Facebook, Twitter, Sparkles, Lock, ArrowUp } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black text-white selection:bg-accent selection:text-black">
      ...
      <div className="bg-accent text-black py-2 px-4 text-[10px] font-black uppercase tracking-[0.4em] text-center z-50">
        SIALKOT MANUFACTURING CAPITAL • GLOBAL EXPORT HUB • SHIP WORLDWIDE
      </div>
      ...
      <nav className={`fixed w-full top-8 z-40 transition-all duration-500 px-4 md:px-10 ${scrolled ? 'top-2' : ''}`}>
        <div className={`max-w-7xl mx-auto rounded-[2rem] transition-all duration-500 border border-white/5 ${scrolled ? 'bg-black/80 backdrop-blur-2xl py-4 shadow-2xl border-white/10' : 'bg-transparent py-6'}`}>
          <div className="px-6 md:px-10 flex justify-between items-center">
            ...
            <a href="#/" className="text-3xl font-black tracking-tighter uppercase flex items-center gap-1 group italic">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-20 mb-24">
            <div className="md:col-span-5">
              <h3 className="text-3xl font-black uppercase mb-10 italic">SIALKOT<span className="text-accent">SHOP</span></h3>
              <p className="text-gray-500 text-sm max-w-sm mb-12 leading-relaxed uppercase tracking-widest font-bold opacity-60">
                The global benchmark for technical apparel. Direct factory integration ensuring elite standards at wholesale valuations.
              </p>
            ...
            <div className="md:col-span-3">
              <h4 className="text-accent font-black uppercase text-[10px] tracking-[0.5em] mb-10">Sync Centers</h4>
              <ul className="space-y-6 text-xs font-black uppercase tracking-widest text-gray-400">
                <li><a href="#/shop?category=Men" className="hover:text-accent transition-colors flex items-center gap-3">Men's Tactical</a></li>
                <li><a href="#/shop?category=Women" className="hover:text-accent transition-colors flex items-center gap-3">Women's Elite</a></li>
                <li><a href="#/smart-pricing" className="hover:text-accent transition-colors flex items-center gap-3"><Sparkles size={12} /> AI Lens Audit</a></li>
              </ul>
            </div>
            <div className="md:col-span-4">
              <h4 className="text-accent font-black uppercase text-[10px] tracking-[0.5em] mb-10">Export Control</h4>
              <ul className="space-y-6 text-xs text-gray-500 font-bold uppercase tracking-widest">
                <li className="flex items-center gap-4 border-b border-white/5 pb-4"><MessageCircle size={18} className="text-accent" /> HQ: +92 303 9877968</li>
                <li><a href="#/admin" className="hover:text-white flex items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/10"><Lock size={16} className="text-accent" /> Access Admin Portal</a></li>
              </ul>
            </div>
          </div>
